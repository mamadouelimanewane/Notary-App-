/**
 * BARÈME - SCI CONSTITUTION AVEC APPORT EN NATURE
 */
...
const FRAIS_FIXE = {
    ...
    conservationFonciere: 100_000, // 1% selon barème
    immeuble: 300_000 // 3% de la valeur de l'apport (10M)
};

export function calculerSCINature(
    capitalTotal: number,
    ...
    // Immeuble (3% de la valeur de l'apport en nature - capital en nature immeuble)
    const immeuble = capitalNature * 0.03;
    ...
    const totalHT = honoraires + enregistrement + immeuble +
        ...
        FRAIS_FIXE.droitsInscription + FRAIS_FIXE.conservationFonciere;
    const totalTTC = totalHT + tva;

    return {
        typeSociete: 'SCI_NATURE',
