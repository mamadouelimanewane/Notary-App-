...
const FRAIS_FIXE = {
    enregistrement: 1_000_000, // 5% du prix
    morcellement: 20_000,
    droitsMutation: 20_000,
    expeditions: 80_000
};

export function calculerDationPaiement(
    prix: number
