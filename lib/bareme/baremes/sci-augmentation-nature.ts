/**
 * BARÈME - SCI AUGMENTATION DE CAPITAL EN NATURE
 */
...
export function calculerSCIAugmentationNature(
    ...
    const totalHT = honoraires + enregistrement + conservationFonciere +
        FRAIS_FIXE.expeditions + FRAIS_FIXE.divers + FRAIS_FIXE.droitsInscription;
    const totalTTC = totalHT + tva;

    return {
        typeSociete: 'SCI_AUGMENTATION_NATURE',
