/**
 * BARÈME - SA CONSTITUTION AVEC CONSEIL D'ADMINISTRATION
 */
...
export function calculerSAConseilAdmin(capital: number): CalculProvisionResult {
    if (capital <= 0) {
