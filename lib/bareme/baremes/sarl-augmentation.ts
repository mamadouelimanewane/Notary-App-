/**
 * BARÈME - SARL AUGMENTATION DE CAPITAL
 */
...
const BAREME_HONORAIRES: BaremeTranche[] = [
    ...
    { min: 300_000_000, max: 600_000_000, taux: 0.005, description: "Plus de 300 Millions" },
...
export function calculerSARLAugmentation(
