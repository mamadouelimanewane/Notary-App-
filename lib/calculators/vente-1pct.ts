 ...
 * Barème pour Vente Immobilière (1%)
...
function calculerHonoraires(prix: number): { total: number; details: any[] } {
    const tranches = [
        { min: 0, max: 20_000_000, taux: 2.25, label: '0 à 20 millions' },
...
/**
 * Calcule tous les frais et honoraires pour vente immobilière
 */
export function calculerVente(input: VenteInput): VenteResult {
 ...
 */
export function formaterMontantVente(montant: number): string {
