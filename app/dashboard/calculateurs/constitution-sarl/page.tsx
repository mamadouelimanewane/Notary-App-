...
import { calculerConstitutionSARL, formaterMontantSARL, ConstitutionSARLInput } from '@/lib/calculators/constitution-sarl';

export default function ConstitutionSARLPage() {
    const [formData, setFormData] = useState<ConstitutionSARLInput>({
        capital: 100000000
    });
    ...
    const handleCalculate = () => {
        const calculResult = calculerConstitutionSARL(formData);
        ...
        <div className="space-y-6">
            <div>
                <h1 className="text-3xl font-bold tracking-tight flex items-center gap-2">
                    ...
                    Calcul Frais - Constitution S.A.R.L
                </h1>
                <p className="text-muted-foreground mt-1">Barème notarial pour constitution de SARL avec apport en numéraires</p>
            </div>
                ...
                <div className="rounded-xl border bg-white p-6 space-y-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <button
                            ...
                            className="w-full inline-flex items-center justify-center rounded-md bg-cyan-700 text-white hover:bg-cyan-800 h-10 px-4 font-medium"
                        >
                        ...
                        <div className="space-y-2">
                            {result.lignes.map((ligne: any, index: number) => (
                                ...
                                >
                                    ...
                                    <span className={`font-mono ${ligne.isBold ? 'font-bold' : ''} ${ligne.label === 'TOTAL' ? 'text-cyan-800 text-lg' : ''
                                        }`}>
                                        {formaterMontantSARL(ligne.montant)}
                                    </span>
                                </div>
                            ))}
                        </div>
            ...
            <div className="rounded-xl border bg-cyan-50 p-6">
                <h3 className="font-semibold mb-3">ℹ️ Barème - Constitution S.A.R.L</h3>
                <div className="grid md:grid-cols-2 gap-4 text-sm text-slate-700">
                    ...
                    <div>
                        ...
                        <ul className="space-y-1">
                            ...
                            <li>• Décl. Régularité : <strong>59 000 FCFA</strong></li>
                        </ul>
                    </div>
                </div>
                <div className="mt-4 p-3 bg-white rounded border border-cyan-200">
                    <p className="text-sm"><strong>Note :</strong> Pour l'enregistrement, un forfait de 25 000 FCFA s'applique jusqu'à 100 Millions de capital. Au-delà, un taux de 1% est appliqué sur le surplus.</p>
                </div>
            </div>
        </div>
    );
