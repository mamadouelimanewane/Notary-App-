...
import { calculerBaremeAttribution, formaterMontantBareme, BaremeInput } from '@/lib/calculators/bareme-attribution';

export default function BaremeAttributionPage() {
    const [formData, setFormData] = useState<BaremeInput>({
        prix: 9250000,
    ...
    const handleCalculate = () => {
        const calculResult = calculerBaremeAttribution(formData);
        ...
        <div className="space-y-6">
            <div>
                <h1 className="text-3xl font-bold tracking-tight flex items-center gap-2">
                    ...
                    Calcul Frais et Honoraires - Attribution par Partage
                </h1>
                <p className="text-muted-foreground mt-1">Barème COHAG - Notaires Associés</p>
            </div>
                ...
                <div className="rounded-xl border bg-white p-6 space-y-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <button
                            ...
                            className="w-full inline-flex items-center justify-center rounded-md bg-purple-600 text-white hover:bg-purple-700 h-10 px-4 font-medium"
                        >
                        ...
                        <div className="space-y-2">
                            {result.lignes.map((ligne: any, index: number) => (
                                ...
                                >
                                    ...
                                    <span className={`font-mono ${ligne.isBold ? 'font-bold' : ''} ${ligne.label === 'TOTAL' ? 'text-purple-700 text-lg' : ''
                                        }`}>
                                        {formaterMontantBareme(ligne.montant)}
                                    </span>
                                </div>
                            ))}
                        </div>
            ...
            <div className="rounded-xl border bg-purple-50 p-6">
                <h3 className="font-semibold mb-3">ℹ️ Barème des honoraires</h3>
                <div className="grid md:grid-cols-2 gap-4 text-sm text-slate-700">
                    ...
                    <div>
                        ...
                        <ul className="space-y-1">
                            ...
                            <li>• Enregistrement : <strong>5%</strong> du prix</li>
